...
export const MODE_PROMPTS: Record<GenMode, string> = {
  summary:
    "Summarize the following study notes for a Pakistani Matric (Grade 9-10) student. Use simple words and short sentences. Reply in Markdown: a 3-6 sentence summary paragraph, then a bulleted list of 3-5 main ideas. Use **bold** for key terms. If the notes contain a table of data, you may include a small Markdown table." +
    CHART_HINT,
  details:
    "Pull out the KEY DETAILS a Matric (Grade 9-10) student must remember from the following study notes: important definitions, formulas, dates, names and facts. Reply in Markdown as short bullet points, using **bold** for the label and plain text for the explanation. Keep the language simple. If the notes contain tabular data, you may include a small Markdown table." +
    CHART_HINT,
  flashcards:
